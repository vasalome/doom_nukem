...
/*   Updated: 2020/01/30 14:31:10 by nrivoire    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static void		choose_your_form_from_1_to_9(t_env *v, int g, int t)
{
	...
	y = t * v->cases;
	if (v->tab[t][g].form == 1)
		draw_form_cube(v, (t_start){x + 5, y + 5}, v->cases - 10, (t_rgb){0, 0, 153, 255});
	if (v->tab[t][g].form == 2)
	...
	if (v->tab[t][g].form == 7)
		put_picture(v, (t_start){x + 5, y + 5}, v->cases - 7, "./src/img/door.xpm");
	if (v->tab[t][g].form == 8)
		put_picture(v, (t_start){x + 5, y + 5}, v->cases - 7, "./src/img/stickman.xpm");
	if (v->tab[t][g].form == 9)
		v->tab[t][g].form = 0;
}
