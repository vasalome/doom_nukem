...
//	printf("%f %f\n", info->ray.x_ray_direction, info->ray.x_ray_direction);
    ...
    //calcul selon direction du mur (N/S || O/E)
	if (info->wall.side == 0)
