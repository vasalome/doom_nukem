...
/*   Updated: 2020/02/07 12:35:48 by nrivoire    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
//     SDL_GetMouseState(&x, &y);
//     //background
//     info->head[0].texture = SDL_CreateTextureFromSurface(info->win.ren, info->head[0].img);

//     //doom logo
//     i = 1;
//     info->head[i].texture = SDL_CreateTextureFromSurface(info->win.ren, info->head[i].img);
//     SDL_QueryTexture(info->head[i].texture, NULL, NULL, &info->head[i].w, &info->head[i].h);
...
//     /*info->fps.texture2 = SDL_CreateTextureFromSurface(info->win.ren, info->head[1].img);
